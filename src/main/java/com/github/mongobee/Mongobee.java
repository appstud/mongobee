...
public class Mongobee implements InitializingBean {
  ...
  private Object executeChangeSetMethod(Method changeSetMethod, Object changeLogInstance, DB db, MongoDatabase mongoDatabase)
    ...
    if (changeSetMethod.getParameterTypes().length == 1
      ...
      return changeSetMethod.invoke(changeLogInstance, mongoTemplate != null ? mongoTemplate : new MongoTemplate((com.mongodb.client.MongoClient) db.getMongoClient(), dbName));
      ...
      return changeSetMethod.invoke(changeLogInstance, mongoTemplate != null ? mongoTemplate : new MongoTemplate((com.mongodb.client.MongoClient) db.getMongoClient(), dbName), springEnvironment);
    } else if (changeSetMethod.getParameterTypes().length == 1
